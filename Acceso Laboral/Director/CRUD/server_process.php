<?php
	...
	*/
	...
	$aColumnas = array( 'id', 'nombre', 'correo', 'telefono' );//Solo las que se vana a utilizar
	
	/* columna que se va indexada */
	$sIndexColumn = "id";
	...
	}//Aquí procesa la consulta y hace una buena páginacion
	...
	}//Es igual que el de ordenamiento
	
	//Filtracion
	$sWhere = "";//Aquí puedo hacer mí script en MySQL
	if ( $_GET['sSearch'] != "" )
	{
		$sWhere = "WHERE (";
	...
	*/
	...
	while ( $aRow = $rResult->fetch_array())
	{
		...
		for ( $i=0 ; $i<count($aColumnas) ; $i++ )
		{
			...
			//Cuando vas a concatenar, tienes que usar comillas dobles 
		...
		$output['aaData'][] = $row;//Aquí va a imprimir todo
	}
